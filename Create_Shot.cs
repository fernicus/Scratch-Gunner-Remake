...
int shotdelay = 60;
	...
	void Update () {
		...
		if(gameObject.name == "Sphere") {
			...
			// Charging the shot for at least 120 frames, but less than 240 frames, will produce
			...
			// Charging the shot for 240 or more frames produces a supercharged shot! This also
